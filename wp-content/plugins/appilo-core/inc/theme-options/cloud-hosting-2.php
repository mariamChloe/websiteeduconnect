...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'switch',
    'settings'    => 'ch2_top_header_switch',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'typography',
    'settings'    => 'ch2_top_header_icon_color',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'typography',
    'settings'    => 'ch2_top_header_icon_hover_color',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'background',
    'settings'    => 'ch2_top_header_bg',
    'label'       => esc_html__( 'Top Header BG', 'appilo' ),
    'description' => esc_html__( 'Change top header background', 'appilo' ),
    'section'     => 'appilo_top_header_styling',
    'default'     => [
        'background-color'      => '',
        'background-image'      => '',
    ...
    'output'      => [
        [
            'element' => '.host-app-header-section .top-bar',
        ],
    ],
    'required'    => array(
        array(
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'background',
    'settings'    => 'ch2_header_bottom_bg',
    'label'       => esc_html__( 'Header Bottom BG', 'appilo' ),
    'description' => esc_html__( 'Change header bottom background', 'appilo' ),
    'section'     => 'appilo_header_styling',
    'default'     => [
        'background-color'      => '',
        'background-image'      => '',
    ...
    'output'      => [
        [
            'element' => '.homePageTwo .host-app-header-section .feature .feature-wrapper',
        ],
    ],
    'required'    => array(
        array(
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'switch',
    'settings'    => 'ch2_bottom_header',
    'label'       => esc_html__( 'Bottom Header', 'appilo' ),
    'description'       => esc_html__( 'Enable and disable Header Bottom', 'appilo' ),
    'section'     => 'appilo_header_styling',
    'default'     => '1',
    'choices'     => [
        'on'  => esc_html__( 'Enable', 'appilo' ),
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'typography',
    'settings'    => 'ch2_body_fonts_settings',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'background',
    'settings'    => 'ch2_menu_btn_hiver_bg',
...
Kirki::add_field( 'appilo_customizer', [
    ...
    'output'      => [
        [
            'element' => '.homePageTwo .host-app-header-section .navbar .navbar-collapse .navbar-nav li a, 
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'typography',
    'settings'    => 'ch2_main_menu_hover_fonts',
    'label'       => esc_html__( 'Main Menu Hover Fonts', 'appilo' ),
    'section'     => 'appilo_header_styling',
    'default'     => [
        'font-family'    => '',
    ...
    'output'      => [
        [
            'element' => '.homePageTwo .host-app-header-section .navbar .navbar-collapse .navbar-nav li.active a, 
            .homePageTwo .host-app-header-section .feature .feature-wrapper li a:hover, 
            .homePageTwo .host-app-header-section .navbar .navbar-collapse .navbar-nav li a:hover',
        ],
    ],
    'required'    => array(
        array(
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'dimensions',
    'settings'    => 'ch2_main_menu_padding',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'typography',
    'settings'    => 'ch2_sub_menu_hover_fonts',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'background',
    'settings'    => 'ch2_sub_menu_bg_hover',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'textarea',
    'settings'    => 'ch2_footer_copyright_txt',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'typography',
    'settings'    => 'ch2_footer_copyright_txt_fonts',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'background',
    'settings'    => 'ch2_copyright_footer_bg',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'typography',
    'settings'    => 'ch2_footer_menu_fonts',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'typography',
    'settings'    => 'ch2_footer_menu_h_fonts',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'typography',
    'settings'    => 'ch2_footer_widget_title',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'typography',
    'settings'    => 'ch2_footer_widget_text',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'dimensions',
    'settings'    => 'ch2_footer_bg_padding',
