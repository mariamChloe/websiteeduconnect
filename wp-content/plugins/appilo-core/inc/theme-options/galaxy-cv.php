...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'typography',
    'settings'    => 'galaxy_cv_heading_font_settings',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'typography',
    'settings'    => 'galaxy_cv_body_fonts_settings',
...
Kirki::add_section( 'galaxy_cv_header_social', array(
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'switch',
    'settings'    => 'cv_social_switcher',
    'label'       => esc_html__( 'Turn ON/OFF Socials', 'appilo' ),
    'section'     => 'galaxy_cv_header_social',
    'default'     => '1',
    'priority'    => 10,
    'choices'     => [
...
Kirki::add_field( 'appilo_customizer', [
    ...
    'settings'     => 'galaxy_cv_social_header_list',
    'fields' => [
        'icon_name' => [
            'type'        => 'text',
...
Kirki::add_section( 'galaxy_cv_lang_section', array(
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'switch',
    'settings'    => 'cv_language_switcher',
    'label'       => esc_html__( 'Turn ON/OFF Language', 'appilo' ),
    'section'     => 'galaxy_cv_lang_section',
    'default'     => '1',
    'priority'    => 10,
    'choices'     => [
        'on'  => esc_html__( 'Enable', 'appilo' ),
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'image',
    'settings'    => 'galaxy_cv_lang_default_image',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'link',
    'settings'    => 'galaxy_cv_lang_default_link',
    'section'     => 'galaxy_cv_lang_section',
    'default'     => '#',
    'required'    => array(
        array(
...
Kirki::add_field( 'appilo_customizer', [
    ...
    'settings'     => 'galaxy_cv_header_lang_list',
    'fields' => [
        'lang_name' => [
            'type'        => 'text',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'color',
    'settings'    => 'galaxy_cv_primary_color_1',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'color',
    'settings'    => 'galaxy_cv_primary_color_2',
    'section'     => 'appilo_color_control',
    'default'     => '#4273f0',
    'required'    => array(
        array(
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'background',
    'settings'    => 'galaxy_cv_footer_color',
