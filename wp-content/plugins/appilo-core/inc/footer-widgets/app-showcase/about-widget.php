...
class Aboutwidget_Widget extends WP_Widget {

    function __construct() {
        parent::__construct(
            'aboutwidget_widget',
            esc_html__( 'App Showcase About Widget ', 'appilo' ),
            array( 'description' => esc_html__( 'App Showcase about widget', 'appilo' ), ) // Args
        );
    ...
    public function widget( $args, $instance ) {
        ...
        $ei_about_logo_id = apply_filters( 'ei_about_logo_uri', $instance[ 'ei_about_logo' ] );
        $ei_about_logo = wp_get_attachment_url($ei_about_logo_id);
        $ei_pay_logo_id = apply_filters( 'ei_pay_logo_uri', $instance[ 'ei_pay_logo' ] );
        $ei_pay_logo = wp_get_attachment_url($ei_pay_logo_id);

        echo $args['before_widget'];

        echo '<div class="ei-footer-logo">
                <img src="'.esc_url($ei_about_logo).'" alt>
            </div>
            <p>
                '.$instance['ei_about_txt'].'
            </p>
            <div class="ei-payment-mathod">
                <img src="'.esc_url($ei_pay_logo).'" alt>
            </div>';
...
function register_aboutwidget_widget() {
    register_widget( 'Aboutwidget_Widget' );
}
add_action( 'widgets_init', 'register_aboutwidget_widget' );