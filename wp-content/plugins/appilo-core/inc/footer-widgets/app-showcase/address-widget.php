<?php
// Adds widget: App Showcase Address Widget
class Appshowcaseaddresswi_Widget extends WP_Widget {

    function __construct() {
        parent::__construct(
            'appshowcaseaddresswi_widget',
            esc_html__( 'App Showcase Address Widget', 'appilo' ),
            array( 'description' => esc_html__( 'App Showcase Address Footer Widget', 'appilo' ), ) // Args
        );
    ...
    public function widget( $args, $instance ) {
        ...
        $ei_app_logo_id = apply_filters( 'ei_app_logo_uri', $instance[ 'app_img' ] );
        $ei_app_logo = wp_get_attachment_url($ei_app_logo_id);
        $ei_play_logo_id = apply_filters( 'ei_play_logo_uri', $instance[ 'play_img' ] );
        $ei_play_logo = wp_get_attachment_url($ei_play_logo_id);
        ...
        echo '<h4>
                ...
                <div class="download-btn">
                    <a href="'.$instance['app_link'].'"><img src="'.esc_url($ei_app_logo).'" alt></a>
                    <a href="'.$instance['play_link'].'"><img src="'.esc_url($ei_play_logo).'" alt></a>
                </div>
...
function register_appshowcaseaddresswi_widget() {
    register_widget( 'Appshowcaseaddresswi_Widget' );
}
add_action( 'widgets_init', 'register_appshowcaseaddresswi_widget' );