<?php
// Adds widget: About Widget
class DiaAboutwidget_Widget extends WP_Widget {

    function __construct() {
        parent::__construct(
            'diaaboutwidget_widget',
            esc_html__( 'Digital Agency About Widget ', 'appilo' ),
            array( 'description' => esc_html__( 'Digital Agency about widget', 'appilo' ), ) // Args
        );
    ...
    public function widget( $args, $instance ) {
        ...
        $dia_about_logo_id = apply_filters( 'dia_about_logo_uri', $instance[ 'dia_about_logo' ] );
        $dia_about_logo = wp_get_attachment_url($dia_about_logo_id);
        $dia_pay_logo_id = apply_filters( 'dia_pay_logo_uri', $instance[ 'dia_pay_logo' ] );
        $dia_pay_logo = wp_get_attachment_url($dia_pay_logo_id);

        echo $args['before_widget'];

        echo '<div class="dia-footer-logo">
                <img src="'.esc_url($dia_about_logo).'" alt>
            </div>
            <p>
                '.$instance['dia_about_txt'].'
            </p>
            <div class="dia-payment-mathod">
                <img src="'.esc_url($dia_pay_logo).'" alt>
            </div>';
...
function register_dia_aboutwidget_widget() {
    register_widget( 'DiaAboutwidget_Widget' );
}
add_action( 'widgets_init', 'register_dia_aboutwidget_widget' );