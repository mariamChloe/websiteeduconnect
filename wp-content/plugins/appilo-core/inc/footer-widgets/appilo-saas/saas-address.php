...
class Saasaddresswidget_Widget extends WP_Widget {

    function __construct() {
        parent::__construct(
            'saasaddresswidget_widget',
            esc_html__( 'SaaS Address widget', 'appilo' ),
            array( 'description' => esc_html__( 'SaaS footer address widget', 'appilo' ), ) // Args
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        echo'<div class="footer_address ul-li clearfix">
                <ul>';
        if ( ! empty( $instance['field_title_one'] ) || ! empty( $instance['field_title_one'] ) ) {
            echo '<li><span>' . $instance['field_title_one'] . '</span> ' . $instance['field_info_one'] . '</li>';
        }
        if ( ! empty( $instance['field_title_two'] ) || ! empty( $instance['field_title_two'] ) ) {
            echo '<li><span>' . $instance['field_title_two'] . '</span> ' . $instance['field_info_two'] . '</li>';
        }
        if ( ! empty( $instance['field_title_three'] ) || ! empty( $instance['field_title_three'] ) ) {
            echo '<li><span>' . $instance['field_title_three'] . '</span> ' . $instance['field_info_three'] . '</li>';
        }
        if ( ! empty( $instance['field_title_four'] ) || ! empty( $instance['field_title_four'] ) ) {
            echo '<li><span>' . $instance['field_title_four'] . '</span> ' . $instance['field_info_four'] . '</li>';
        }
...
function register_saasaddresswidget_widget() {
    register_widget( 'Saasaddresswidget_Widget' );
}
add_action( 'widgets_init', 'register_saasaddresswidget_widget' );