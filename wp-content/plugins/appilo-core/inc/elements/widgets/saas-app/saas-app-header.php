...
class saas_app_header extends Widget_Base {

   public function get_name() {
      return 'saas_app_header';
   }

   public function get_title() {
      return __( 'Saas App Header', 'appilo' );
   }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .container-1590' => 'max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header__border' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'main_nav_active_color',
            [
                'label' => esc_html__( 'Main Nav Active Color', 'appilo' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .main-menu ul li .submenu li a' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'btn__1_bg',
                'label' => esc_html__( 'Button 1 BG', 'appilo' ),
                'types' => [ 'gradient' ],
                'selector' => '{{WRAPPER}} .thm-btn__transparent',
            ]
        );
        $this->add_control(
            'btn__2_color',
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'btn__2_bg',
                'label' => esc_html__( 'Button 2 BG', 'appilo' ),
                'types' => [ 'gradient' ],
                'selector' => '{{WRAPPER}} .thm-btn',
            ]
        );
        ...
        $this->add_control(
            'btn_1_hover_color',
            [
                'label' => esc_html__( 'Button 1 Hover Color', 'appilo' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Button 1 Hover BG', 'appilo' ),
                'types' => [ 'gradient' ],
                'selector' => '{{WRAPPER}} .thm-btn__transparent:hover',
            ]
        );
    ...
    <div class="container maxw_1590 container-1590">
        <div class="header__main">
            ...
            <div class="header__button ul_li">
                <?php
                    if ($settings['button_link_1']['url']):
                ?>
                <a class="thm-btn thm-btn__transparent" href="<?php echo $settings['button_link_1']['url']; ?>">
                    <span class="btn-wrap">
                        <span><?php echo $settings['button_text_1']; ?></span>
                        <span><?php echo $settings['button_text_1']; ?></span>
                    </span>
                </a>
                <?php endif; ?>
                ...
                ?>
                <a class="thm-btn" href="<?php echo $settings['button_link_2']['url']; ?>">
                    <span class="btn-wrap">
...
Plugin::instance()->widgets_manager->register( new saas_app_header() );
?>