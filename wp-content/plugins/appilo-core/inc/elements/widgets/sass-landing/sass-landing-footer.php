...
class sass_landing_footer extends Widget_Base
{

    public function get_name()
    {
        return 'seo-landing-footer';
    }

    public function get_title()
    {
        return __('Sass Footer', 'appilo');
    }
    ...
    protected function render()
    {
        ...
        <!-- footer start -->
        <footer class="sl-footer pos-rel pt-100">
                ...
                <div class="row pb-100 mt-none-30">
                    ...
                    <div class="col-lg-2 col-md-6 footer__widget-col mt-30">
                        <div class="footer__widget">
                            ...
                            <ul class="footer__links list-unstyled">
                                <?php foreach($settings['a_items'] as $m_item): ?>
                                <li><a href="<?php echo esc_url($m_item['a_link']['url']); ?>"><?php echo esc_html($m_item['a_text']); ?></a></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                    </div>
...
Plugin::instance()->widgets_manager->register(new sass_landing_footer());
